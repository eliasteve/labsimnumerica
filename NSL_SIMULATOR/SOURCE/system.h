...
private:
  ...
  int _neqsteps = 0;    // Number of equilibration steps
  ...
  bool _include_tail; //Flag for including tail corrections in the calculation of pressure, potential energy
...
public: // Function declarations
  ...
  int get_neqsteps();         // Get number of equilibration steps
  ...
  void check_property_dependences();
